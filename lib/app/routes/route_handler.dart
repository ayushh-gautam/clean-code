...
import 'package:newproject/module/home/pages/secondPage.dart';

import '../../module/home/pages/homePage.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    //     screen: CommomBodyWidget(screenName: settings.name!),); //
    ...
    case Routes.secondPage:
      return _getPageRoute(
          routeName: settings.name!, screen: const SecondPage());
